...
/**
 * FiniteStrainUObasedCPDamage_modified is the coupling between
 * crystal plasticity and damage
 */
class FiniteStrainUObasedCPDamage_modified : public FiniteStrainUObasedCP
{
public:
  static InputParameters validParams();

  FiniteStrainUObasedCPDamage_modified(const InputParameters & parameters);
