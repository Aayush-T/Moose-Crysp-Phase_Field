...
[Materials]
  ...
  [./crysp] # new class with damage
    ...
    type = FiniteStrainUObasedCP_PF_new_mod
	  c = c
    stol = 1e-2
    maximum_substep_iteration = 3 # exponential in nature
    tan_mod_type = none #exact # using the one that accounts for Plasticity
...
[Executioner]
  ...
  petsc_options_iname = -pc_hypre_type #superlu
